        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try {
                ...
                */
                    ...
                    System.out.println("Socket is working now");
                ...
                System.out.println(e + " IO Exception Occurred");
                e.printStackTrace();
            } catch (ClassNotFoundException e) {
                Log.e(TAG, "Class Not Found Exception has occurred.");
                e.printStackTrace();
            }
        ...
        protected Void doInBackground(String... msgs) {
            try {
                ...
                try {
                    ...
                    System.out.println("Exception at client side");
                    Log.e(TAG, "Exception " + e + " occurred at client side");
                    e.printStackTrace();
                }

            } catch (UnknownHostException e) {
                Log.e(TAG, "Exception " + e + " ClientTask UnknownHostException");
                e.printStackTrace();
            } catch (IOException e) {
                Log.e(TAG, "Exception " + e + " ClientTask socket IOException");
                e.printStackTrace();
            }
